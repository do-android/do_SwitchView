...
public class do_SwitchView_View extends DoCustomSwitch implements DoIUIModuleView, do_SwitchView_IMethod {
	...
	public void onPropertiesChanged(Map<String, String> _changedValues) {
		...
		if (_changedValues.containsKey("shape")) {
			String _shapeVal = _changedValues.get("shape");
			if ("rect".equalsIgnoreCase(_shapeVal)) {
				this.setShapeType(DoCustomSwitch.SHAPE_RECT);
			} else {
				this.setShapeType(DoCustomSwitch.SHAPE_CIRCLE);
			}
		}

		if (_changedValues.containsKey("colors")) {
			this.setColors(_changedValues.get("colors"));
		}
	}
